...
fun ZonaScreen(
    ...
    LaunchedEffect(state.userMessage) {
        viewModel.onEvent(ZonaUiEvent.LoadZona)
    ...
    Box(modifier = modifier.fillMaxSize()) {
        Column(
            ...
            Row(
                ...
                Text(
                    text = if (state.isMentor) "Mi Zona" else "Zona de Gemas",
            ...
            ZonaContentRouter(state, state.isMentor, viewModel::onEvent)
        }
